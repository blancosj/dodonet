...
namespace Newtonsoft.Json
{
	...
	public static class JavaScriptConvert
	{
		...
		public static string ToString(DateTime value)
		{
			...
			long javaScriptTicks = (value.Ticks - InitialJavaScriptDateTicks) / (long)10000;
        ...
        public static object DeserializeObject(string value, Type type, params object[] args)
        {
            StringReader sr = new StringReader(value);
            JsonSerializer jsonSerializer = new JsonSerializer();
            ...
            using (JsonReader jsonReader = new JsonReader(sr))
            {
                deserializedValue = jsonSerializer.Deserialize(jsonReader, type, args);
            }

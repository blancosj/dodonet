...
namespace DodoNet.Compression.BZip2
{
	...
	public sealed class BZip2
	{
		...
		{			
			...
			using ( inStream ) {
                using (Limada.SharpZipLib.BZip2_085.BZip2OutputStream bzos = new Limada.SharpZipLib.BZip2_085.BZip2OutputStream(outStream, blockSize))
                {
                    bzos.IsStreamOwner = false;

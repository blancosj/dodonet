...
namespace DodoNet.Http
{
    ...
    public sealed class ContentTypes
    {
        static Hashtable InitContentTypes()
        {
            ...
            extensionTypes.Add(".csv", "application/excel");
            extensionTypes.Add(".xls", "application/excel");
            extensionTypes.Add(".latex", "application/x-latex");
            extensionTypes.Add(".dll", "application/x-msdownload");
            ...
            extensionTypes.Add(".pdf", "application/pdf");
            ...
            extensionTypes.Add(".mp3", "audio/mpeg");
            ...
            extensionTypes.Add(".ico", "image/x-icon");
            ...
            extensionTypes.Add(".config", "application/octet-stream");
            extensionTypes.Add(".xml", "text/xml");
            extensionTypes.Add(".xsl", "text/xsl");
            extensionTypes.Add(".html", "text/html");
            extensionTypes.Add(".htm", "text/html");
            extensionTypes.Add(".asp", "text/html");
            extensionTypes.Add(".aspx", "text/html");
            extensionTypes.Add(".js", "text/javascript");
            extensionTypes.Add(".ls", "text/javascript");
            extensionTypes.Add(".mocha", "text/javascript");
            extensionTypes.Add(".abx", "text/plain");
